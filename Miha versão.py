...
class TelegramBot:
    def __init__(self):
        token = '1539776321:AAEwUBBITZx7-v31vnacozVFqImCcwZpiE8'
    ...
    def criar_resposta(self, mensagem, eh_primeira_mensagem):
        if eh_primeira_mensagem == True or mensagem in ('menu', 'Menu'):
            return f'''Olá bem vindo a loja do free fire, Escolha o intem desejado:{os.linesep}1 - Calça angelical{os.linesep}2 - Passe de elite{os.linesep}3 - Diabão'''
        if mensagem == '1':
            return '''Calça angelical 250 R${os.linesep}Confirmar pedido?(s/n)'''
        elif mensagem == '2':
